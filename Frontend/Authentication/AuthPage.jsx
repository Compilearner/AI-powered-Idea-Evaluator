 ...
 const handleState = ()=>{
  ...
  <div className="h-screen w-full bg-black flex justify-center gap-[11rem] md:gap-[8rem] items-center max-[1000px]:gap-0" >
    <div className="w-1/2 h-screen hidden min-[1000px]:inline">
     ...
     <div  className="lg:w-[37vw] md:w-[45%] h-[67vh] xl:w-[35%] max-[1000px]:w-[65%]  bg-transparent border min-[1000px]:mr-32 border-slate-300 rounded-lg z-[100]  flex flex-col justify-center items-center gap-[2rem] relative"> 
            ...
            <form className="w-full flex flex-col justify-center items-center gap-[1.5rem] overflow-hidden p-[1rem]">
              ...
              <div className="w-full flex flex-col gap-2">
                ...
                <div className="flex justify-center items-center gap-2 text-white mt-[-1.3rem]">
                    ...
                    <button type="button" className="border-none text-blue-400" onClick={handleState}>Login</button>
                </div>
                <button type="submit" className="px-[1rem] py-[.4rem] text-lg font-semibold bg-gray-300 w-[40%] h-[2.5rem] hover:bg-gray-500" onClick={handleRegister}>Register</button>  
                </form> )    
               : (
             <form className="w-full flex flex-col justify-center items-center gap-[1.5rem] overflow-hidden p-[1rem]">
                 <div className="w-full flex flex-col gap-2">
                ...
                <button type="submit" className="px-[1rem] py-[.4rem] text-lg font-semibold bg-gray-300 w-[40%] h-[2.5rem] hover:bg-gray-500"  onClick={handleLogin}>Login</button>  
            </form>
          )
         }
     </div>
