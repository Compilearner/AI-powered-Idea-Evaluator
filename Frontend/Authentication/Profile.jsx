...
const {user} = useAuthStore((state)=> state);
  ...
  return (
  <div className="h-full w-full relative flex flex-col justify-start gap-14 items-center pt-24 pb-6 bg-black">

      {/** User Profile Container */}
      <div className="relative w-full h-[50vh] flex justify-center items-center bg-black border-b border-gray-400">
